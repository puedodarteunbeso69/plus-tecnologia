...
export default function OptimizacionPerformancePage() {
  return (
    <div className="min-h-screen bg-white">
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div className="space-y-8">
              ...
              <div className="flex flex-col gap-4 sm:flex-row sm:gap-4">
                <Link href="/contacto">
                  <Button className="h-12 px-6 text-base bg-yellow-600 hover:bg-yellow-700">
      ...
      {/* Performance Metrics */}
      <section className="py-12 sm:py-16 lg:py-20 bg-gradient-to-r from-yellow-900 to-orange-900 text-white">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
      ...
      {/* Main CTA Section */}
      <section className="py-12 sm:py-16 lg:py-20 bg-gradient-to-r from-yellow-600 to-orange-600">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <div className="max-w-3xl mx-auto space-y-8">
            ...
            <div className="flex flex-col gap-4 sm:flex-row sm:gap-4 justify-center">
              <Link href="/contacto">
                <Button className="h-12 px-6 text-base bg-white text-yellow-600 hover:bg-gray-100 text-lg px-8">
                  Audit Gratuito
                  <ArrowRight className="ml-2 h-5 w-5" />
                </Button>
              </Link>
              <Link href="/contacto">
                <Button variant="outline" className="h-12 px-6 text-base border-white text-white hover:bg-white hover:text-yellow-600 text-lg px-8">
                  Hablar con Experto
                </Button>
              </Link>
            </div>
