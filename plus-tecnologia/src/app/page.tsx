            ...
            <div className="space-y-8">
              ...
              <div className="flex items-center space-x-8 text-sm">
                <div className="flex items-center space-x-2">
                  ...
                  <span className="text-gray-600">+50 Proyectos Exitosos</span>
                </div>
                <div className="flex items-center space-x-2">
      ...
      <section className="py-20">
        <div className="container mx-auto px-4 lg:px-8">
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            <div>
              <OptimizedImage
                src="https://images.unsplash.com/photo-1461749280684-dccba630e2f6?w=600&h=400&fit=crop&auto=format&q=75"
            ...
            {[
              {
                ...
                title: "Flutter vs React Native 2024: Guía Completa de Comparación",
                excerpt: "Análisis detallado de las dos principales tecnologías para desarrollo multiplataforma, incluyendo rendimiento, ecosistema y casos de uso ideales.",
                readTime: "8 min lectura",
                image: "https://images.unsplash.com/photo-1512941937669-90a1b58e7e9c?w=400&h=200&fit=crop&auto=format&q=75",
                href: "/blog/futuro-desarrollo-movil-flutter-vs-react-native-2024",
                tags: ["Flutter", "React Native", "Desarrollo Móvil"]
              },
              {
                category: "Ciberseguridad",
                title: "Principales Amenazas de Ciberseguridad en 2024 y Cómo Protegerse",
                excerpt: "Análisis de las amenazas más críticas que enfrentan las empresas en 2024 y estrategias de protección efectivas.",
                readTime: "6 min lectura",
                image: "https://images.unsplash.com/photo-1558494949-ef010cbdcc31?w=400&h=200&fit=crop&auto=format&q=75",
                href: "/blog/ciberseguridad-2024-amenazas-principales",
                tags: ["Ciberseguridad", "Protección", "Empresa"]
              },
              {
                category: "Cloud Computing",
                title: "Migración Cloud: ROI y Beneficios Reales para tu Empresa",
                excerpt: "Casos de estudio reales de migración a AWS y Azure, con análisis de costos, beneficios y mejores prácticas implementadas.",
                readTime: "10 min lectura",
                image: "https://images.unsplash.com/photo-1451187580459-43490279c0fa?w=400&h=200&fit=crop&auto=format&q=75",
                href: "/blog/migracion-cloud-roi-beneficios-empresas",
