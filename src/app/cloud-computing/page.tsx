...
import { cloudComputingReviews, aggregateRatings } from "@/data/reviewsData";
...
export default function CloudComputingPage() {
  return (
    <div className="min-h-screen bg-white">
      ...
      {/* Hero Section */}
      <section className="py-12 sm:py-16 lg:py-20 bg-gradient-to-br from-sky-50 via-white to-blue-50">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div className="space-y-8">
              ...
              <div className="flex flex-col gap-4 sm:flex-row sm:gap-4">
                <Link href="/contacto">
                  <Button className="h-12 px-6 text-base bg-sky-600 hover:bg-sky-700">
            ...
            {migrationProcess.map((phase, index) => (
              <Card key={index} className="hover:shadow-lg transition-shadow">
                <CardContent className="p-8">
                  <div className="grid lg:grid-cols-4 gap-4 sm:gap-6 items-start">
      ...
      {/* ROI Calculator CTA */}
      <section className="py-8 sm:py-12 lg:py-16 bg-sky-900 text-white">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center space-y-6">
            ...
            <Link href="/contacto">
              <Button className="h-12 px-6 text-base bg-sky-500 hover:bg-sky-400">
      ...
      <ServiceReviews
        ...
        reviews={cloudComputingReviews}
        aggregateRating={aggregateRatings.cloudComputing}
      />

      {/* Main CTA Section */}
      <section className="py-12 sm:py-16 lg:py-20 bg-gradient-to-r from-sky-600 to-blue-600">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <div className="max-w-3xl mx-auto space-y-8">
            ...
            <div className="flex flex-col gap-4 sm:flex-row sm:gap-4 justify-center">
              <Link href="/contacto">
                <Button className="h-12 px-6 text-base bg-white text-sky-600 hover:bg-gray-100 text-lg px-8">
                  Assessment Gratuito
                  <ArrowRight className="ml-2 h-5 w-5" />
                </Button>
              </Link>
              <Link href="/contacto">
                <Button variant="outline" className="h-12 px-6 text-base border-white text-white hover:bg-white hover:text-sky-600 text-lg px-8">
                  Hablar con Experto
                </Button>
              </Link>
            </div>
