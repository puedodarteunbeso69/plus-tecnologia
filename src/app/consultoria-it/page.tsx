...
export default function ConsultoriaITPage() {
  return (
    <div className="min-h-screen bg-white">
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div className="space-y-8">
              ...
              <div className="flex flex-col gap-4 sm:flex-row sm:gap-4">
                <Link href="/contacto">
                  <Button className="h-12 px-6 text-base bg-indigo-600 hover:bg-indigo-700">
      ...
      <section className="py-8 sm:py-12 lg:py-16 bg-indigo-900 text-white">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center space-y-6">
            ...
            <Link href="/contacto">
              <Button className="h-12 px-6 text-base bg-indigo-500 hover:bg-indigo-400">
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <div className="max-w-3xl mx-auto space-y-8">
            ...
            <div className="flex flex-col gap-4 sm:flex-row sm:gap-4 justify-center">
              <Link href="/contacto">
                <Button className="h-12 px-6 text-base bg-white text-indigo-600 hover:bg-gray-100 text-lg px-8">
                  Consulta Estratégica Gratis
                  <ArrowRight className="ml-2 h-5 w-5" />
                </Button>
              </Link>
              <Link href="/contacto">
                <Button variant="outline" className="h-12 px-6 text-base border-white text-white hover:bg-white hover:text-indigo-600 text-lg px-8">
                  Hablar con CTO
                </Button>
              </Link>
            </div>
