      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center space-y-6 sm:space-y-8">
          ...
          <p className="text-sm sm:text-base text-gray-600 max-w-2xl mx-auto mb-8">
            Trabajamos con las principales empresas del IBEX 35 y líderes tecnológicos
          </p>
          ...
          <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-6 gap-4 sm:gap-6 items-center">
            {[
              ...
              <div
                key={company.name}
                className="flex items-center justify-center p-4 sm:p-6 bg-white rounded-lg shadow-sm hover:shadow-lg transition-all duration-300 hover:-translate-y-1 group h-24 sm:h-28 relative"
              >
                <Image
                  src={company.logo}
